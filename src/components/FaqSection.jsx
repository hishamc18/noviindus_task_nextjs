...
const FAQSection = () => {
  ...
  return (
    <section className="bg-[#F9F7F4] h-[650px] flex flex-col justify-center items-center">
      <h2 className="text-center text-[36px] font-Bricolage text-[#49402f] mb-10">
        Frequently asked <span className="font-semibold underline">Questions</span>
      </h2>

      <div className="px-20  mx-auto space-y-2">
        {faqs.map((faq, index) => (
          <div
            key={index}
            className="bg-white rounded-md shadow-sm border-b-1 border-[#CFCFCF]"
          >
            <button
